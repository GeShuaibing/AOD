...
class AFPN(nn.Module):
    def __init__(self,
                 ...
                 out_channels=[256, 512, 1024, 2048], div_n=8):
        super(AFPN, self).__init__()

        self.fp16_enabled = False

        self.conv0 = BasicConv(in_channels[0], in_channels[0] // div_n, 1)
        self.conv1 = BasicConv(in_channels[1], in_channels[1] // div_n, 1)
        self.conv2 = BasicConv(in_channels[2], in_channels[2] // div_n, 1)
        self.conv3 = BasicConv(in_channels[3], in_channels[3] // div_n, 1)

        self.body = nn.Sequential(
            BlockBody([in_channels[0] // div_n, in_channels[1] // div_n, in_channels[2] // div_n, in_channels[3] // div_n])
        )

        self.conv00 = BasicConv(in_channels[0] // div_n, out_channels[0], 1)
        self.conv11 = BasicConv(in_channels[1] // div_n, out_channels[1], 1)
        self.conv22 = BasicConv(in_channels[2] // div_n, out_channels[2], 1)
        self.conv33 = BasicConv(in_channels[3] // div_n, out_channels[3], 1)
