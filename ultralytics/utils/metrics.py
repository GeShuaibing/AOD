...
from ultralytics.utils.iou import IoU_Cal
...
def bbox_iou2(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False,
              DiagIoU=False,
              Focal=False, alpha=1, gamma=0.5, scale=True, eps=1e-7):
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU:
        ...
        if CIoU or DIoU or EIoU or SIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                c = w1 ** 2 + h1 ** 2
                dl1 = 1 - a / c2
                dl2 = torch.abs(a - c) / torch.max(a, c)
                return iou - (dl1 + dl2)
            # elif EIoU:
            elif EIoU:
...
def bbox_iou3(box1, box2, xywh=True, type_='CIoU', eps=1e-7):
    # Returns Intersection over Union (IoU) of box1(1,4) to box2(n,4)
    # Get the coordinates of bounding boxes
    if xywh:  # transform from xywh to xyxy
        (x1, y1, w1, h1), (x2, y2, w2, h2) = box1.chunk(4, -1), box2.chunk(4, -1)
